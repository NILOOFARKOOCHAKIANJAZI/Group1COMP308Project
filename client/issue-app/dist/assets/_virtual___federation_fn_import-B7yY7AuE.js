...
var moduleMap = {
	"react": {
		get: () => () => __federation_import(new URL("__federation_shared_react-BnDlCVKm.js", import.meta.url).href),
		import: true
	},
	"react-dom": {
		get: () => () => __federation_import(new URL("__federation_shared_react-dom-DVQhLKBR.js", import.meta.url).href),
		import: true
	},
	"react-router-dom": {
		get: () => () => __federation_import(new URL("__federation_shared_react-router-dom-C1fmciP8.js", import.meta.url).href),
		import: true
	},
	"@apollo/client": {
		get: () => () => __federation_import(new URL("__federation_shared_@apollo/client-bta1JQ5D.js", import.meta.url).href),
		import: true
	},
	"graphql": {
		get: () => () => __federation_import(new URL("__federation_shared_graphql-DOtSPEY6.js", import.meta.url).href),
		import: true
	}
};
