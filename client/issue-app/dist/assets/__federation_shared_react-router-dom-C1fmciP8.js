import { t as __commonJSMin } from "./chunk-DP_BRqTB.js";
import { r as importShared } from "./_virtual___federation_fn_import-B7yY7AuE.js";
import { t as __vitePreload } from "./preload-helper-Cpz2jaYO.js";
...
var ViewTransitionContext = React$2.createContext({ isTransitioning: false });
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = React$2.createContext(/* @__PURE__ */ new Map());
...
var NavigationContext = React$2.createContext(null);
NavigationContext.displayName = "Navigation";
var LocationContext = React$2.createContext(null);
...
var React2$2 = await importShared("react");
...
function useMatch(pattern) {
	...
	return React2$2.useMemo(() => matchPath(pattern, decodePath(pathname)), [pathname, pattern]);
}
var navigateEffectWarning = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function useIsomorphicLayoutEffect(cb) {
	if (!React2$2.useContext(NavigationContext).static) React2$2.useLayoutEffect(cb);
}
...
function useNavigateUnstable() {
	...
	return React2$2.useCallback((to, options = {}) => {
...
function useOutlet(context) {
	...
	return React2$2.useMemo(() => outlet && /* @__PURE__ */ React2$2.createElement(OutletContext.Provider, { value: context }, outlet), [outlet, context]);
}
function useParams() {
	let { matches } = React2$2.useContext(RouteContext);
...
function useResolvedPath(to, { relative } = {}) {
	...
	let { pathname: locationPathname } = useLocation();
	let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
	return React2$2.useMemo(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [
		to,
		routePathnamesJson,
		locationPathname,
		relative
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`);
	...
	if (locationArg && renderedMatches) return /* @__PURE__ */ React2$2.createElement(LocationContext.Provider, { value: {
		location: {
			pathname: "/",
			search: "",
			hash: "",
...
var RenderErrorBoundary = class extends React2$2.Component {
	...
	render() {
		...
		let result = error !== void 0 ? /* @__PURE__ */ React2$2.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ React2$2.createElement(RouteErrorContext.Provider, {
			value: error,
			children: this.props.component
		})) : this.props.children;
		if (this.context) return /* @__PURE__ */ React2$2.createElement(RSCErrorHandler, { error }, result);
		return result;
	}
};
...
function RSCErrorHandler({ children, error }) {
	...
	if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
		...
		if (redirect2) {
			...
			return /* @__PURE__ */ React2$2.createElement("meta", {
				httpEquiv: "refresh",
...
function _renderMatches(matches, parentMatches = [], dataRouterOpts) {
	...
	return renderedMatches.reduceRight((outlet, match, index) => {
		...
		let getChildren = () => {
			...
			else if (match.route.Component) children = /* @__PURE__ */ React2$2.createElement(match.route.Component, null);
			else if (match.route.element) children = match.route.element;
			else children = outlet;
			return /* @__PURE__ */ React2$2.createElement(RenderedRoute, {
				match,
				routeContext: {
					outlet,
					matches: matches2,
		...
		return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? /* @__PURE__ */ React2$2.createElement(RenderErrorBoundary, {
			location: dataRouterState.location,
...
function useMatches() {
	...
	return React2$2.useMemo(() => matches.map((m) => convertRouteMatchToUiMatch(m, loaderData)), [matches, loaderData]);
}
...
function useAsyncValue() {
	return React2$2.useContext(AwaitContext)?._data;
}
function useAsyncError() {
	return React2$2.useContext(AwaitContext)?._error;
}
var blockerId = 0;
function useBlocker(shouldBlock) {
	...
	let blockerFunction = React2$2.useCallback((arg) => {
...
function useNavigateStable() {
	...
	return React2$2.useCallback(async (to, options = {}) => {
		warning(activeRef.current, navigateEffectWarning);
		if (!activeRef.current) return;
...
var React3$2 = await importShared("react");
var alreadyWarned2 = {};
...
var useOptimisticImpl = React3$2["useOptimistic"];
...
function mapRouteProperties(route) {
	...
	if (route.Component) {
		...
		Object.assign(updates, {
			element: React3$2.createElement(route.Component),
			Component: void 0
		});
	}
	if (route.HydrateFallback) {
		...
		Object.assign(updates, {
			hydrateFallbackElement: React3$2.createElement(route.HydrateFallback),
	...
	if (route.ErrorBoundary) {
		...
		Object.assign(updates, {
			errorElement: React3$2.createElement(route.ErrorBoundary),
...
function RouterProvider({ router, flushSync: reactDomFlushSyncImpl, onError, unstable_useTransitions }) {
	...
	let [_state, setStateImpl] = React3$2.useState(router.state);
	let [state, setOptimisticState] = useOptimisticSafe(_state);
	let [pendingState, setPendingState] = React3$2.useState();
	let [vtContext, setVtContext] = React3$2.useState({ isTransitioning: false });
	let [renderDfd, setRenderDfd] = React3$2.useState();
	let [transition, setTransition] = React3$2.useState();
	let [interruption, setInterruption] = React3$2.useState();
	let fetcherData = React3$2.useRef(/* @__PURE__ */ new Map());
	let setState = React3$2.useCallback((newState, { deletedFetchers, newErrors, flushSync, viewTransitionOpts }) => {
	...
	React3$2.useLayoutEffect(() => router.subscribe(setState), [router, setState]);
	let initialized = state.initialized;
	React3$2.useLayoutEffect(() => {
	...
	let navigator = React3$2.useMemo(() => {
		return {
	...
	let dataRouterContext = React3$2.useMemo(() => ({
		router,
		navigator,
		static: false,
		basename,
	...
	return /* @__PURE__ */ React3$2.createElement(React3$2.Fragment, null, /* @__PURE__ */ React3$2.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React3$2.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React3$2.createElement(FetchersContext.Provider, { value: fetcherData.current }, /* @__PURE__ */ React3$2.createElement(ViewTransitionContext.Provider, { value: vtContext }, /* @__PURE__ */ React3$2.createElement(Router, {
		basename,
		location: state.location,
		navigationType: state.historyAction,
		navigator,
		unstable_useTransitions
	}, /* @__PURE__ */ React3$2.createElement(MemoizedDataRoutes, {
...
var MemoizedDataRoutes = React3$2.memo(DataRoutes);
...
function MemoryRouter({ basename, children, initialEntries, initialIndex, unstable_useTransitions }) {
	let historyRef = React3$2.useRef();
	...
	let [state, setStateImpl] = React3$2.useState({
		action: history.action,
		location: history.location
	});
	let setState = React3$2.useCallback((newState) => {
		if (unstable_useTransitions === false) setStateImpl(newState);
		else React3$2.startTransition(() => setStateImpl(newState));
	}, [unstable_useTransitions]);
	React3$2.useLayoutEffect(() => history.listen(setState), [history, setState]);
	return /* @__PURE__ */ React3$2.createElement(Router, {
		basename,
		children,
		location: state.location,
...
function Navigate({ to, replace: replace2, state, relative }) {
	...
	let { static: isStatic } = React3$2.useContext(NavigationContext);
	warning(!isStatic, `<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`);
	let { matches } = React3$2.useContext(RouteContext);
	let { pathname: locationPathname } = useLocation();
...
function Router({ basename: basenameProp = "/", children = null, location: locationProp, navigationType = "POP", navigator, static: staticProp = false, unstable_useTransitions }) {
	...
	let navigationContext = React3$2.useMemo(() => ({
		basename,
		navigator,
		static: staticProp,
		unstable_useTransitions,
	...
	let locationContext = React3$2.useMemo(() => {
	...
	return /* @__PURE__ */ React3$2.createElement(NavigationContext.Provider, { value: navigationContext }, /* @__PURE__ */ React3$2.createElement(LocationContext.Provider, {
		children,
...
function Await({ children, errorElement, resolve }) {
	let dataRouterContext = React3$2.useContext(DataRouterContext);
	let dataRouterStateContext = React3$2.useContext(DataRouterStateContext);
	let onError = React3$2.useCallback((error, errorInfo) => {
	...
	return /* @__PURE__ */ React3$2.createElement(AwaitErrorBoundary, {
		resolve,
		errorElement,
		onError
	}, /* @__PURE__ */ React3$2.createElement(ResolveAwait, null, children));
}
var AwaitErrorBoundary = class extends React3$2.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		if (status === 2) return /* @__PURE__ */ React3$2.createElement(AwaitContext.Provider, {
			value: promise,
			children: errorElement
		});
		if (status === 1) return /* @__PURE__ */ React3$2.createElement(AwaitContext.Provider, {
			value: promise,
			children
		});
		throw promise;
...
function ResolveAwait({ children }) {
	...
	return /* @__PURE__ */ React3$2.createElement(React3$2.Fragment, null, toRender);
}
function createRoutesFromChildren(children, parentPath = []) {
	let routes = [];
	React3$2.Children.forEach(children, (element, index) => {
		if (!React3$2.isValidElement(element)) return;
		let treePath = [...parentPath, index];
		if (element.type === React3$2.Fragment) {
...
function WithComponentProps({ children }) {
	...
	return React3$2.cloneElement(children, props);
}
function withComponentProps(Component4) {
	return function WithComponentProps2() {
		const props = useRouteComponentProps();
		return React3$2.createElement(Component4, props);
	};
}
...
function withHydrateFallbackProps(HydrateFallback) {
	return function WithHydrateFallbackProps2() {
		const props = useHydrateFallbackProps();
		return React3$2.createElement(HydrateFallback, props);
	};
}
...
function withErrorBoundaryProps(ErrorBoundary) {
	return function WithErrorBoundaryProps2() {
		const props = useErrorBoundaryProps();
		return React3$2.createElement(ErrorBoundary, props);
	};
}
...
var React4$1 = await importShared("react");
var HOLE = -1;
var NAN = -2;
...
function StreamTransfer({ context, identifier, reader, textDecoder, nonce }) {
	...
	let scriptTag = value ? /* @__PURE__ */ React4$1.createElement("script", {
		nonce,
		dangerouslySetInnerHTML: { __html: `window.__reactRouterContext.streamController.enqueue(${escapeHtml(JSON.stringify(value))});` }
	}) : null;
	if (done) return /* @__PURE__ */ React4$1.createElement(React4$1.Fragment, null, scriptTag, /* @__PURE__ */ React4$1.createElement("script", {
		nonce,
		dangerouslySetInnerHTML: { __html: `window.__reactRouterContext.streamController.close();` }
	}));
	else return /* @__PURE__ */ React4$1.createElement(React4$1.Fragment, null, scriptTag, /* @__PURE__ */ React4$1.createElement(React4$1.Suspense, null, /* @__PURE__ */ React4$1.createElement(StreamTransfer, {
		context,
...
var React9 = await importShared("react");
var React8 = await importShared("react");
...
var React7 = await importShared("react");
var React6 = await importShared("react");
var React5 = await importShared("react");
function RemixRootDefaultHydrateFallback() {
	return /* @__PURE__ */ React5.createElement(BoundaryShell, {
		title: "Loading...",
		renderScripts: true
	}, /* @__PURE__ */ React5.createElement("script", { dangerouslySetInnerHTML: { __html: `
              console.log(
...
function getRouteComponents(route, routeModule, isSpaMode) {
	...
	if (route.id === "root" && routeModule.Layout) return {
		...Component4 ? { element: /* @__PURE__ */ React6.createElement(routeModule.Layout, null, /* @__PURE__ */ React6.createElement(Component4, null)) } : { Component: Component4 },
		...ErrorBoundary ? { errorElement: /* @__PURE__ */ React6.createElement(routeModule.Layout, null, /* @__PURE__ */ React6.createElement(ErrorBoundary, null)) } : { ErrorBoundary },
		...HydrateFallback ? { hydrateFallbackElement: /* @__PURE__ */ React6.createElement(routeModule.Layout, null, /* @__PURE__ */ React6.createElement(HydrateFallback, null)) } : { HydrateFallback }
	};
	return {
...
function Links({ nonce, crossOrigin }) {
	...
	let keyedLinks = React8.useMemo(() => getKeyedLinksForMatches(matches, routeModules, manifest), [
		matches,
		routeModules,
		manifest
	]);
...
function PrefetchPageLinks({ page, ...linkProps }) {
	...
	let matches = React8.useMemo(() => matchRoutes(router.routes, page, router.basename), [
		router.routes,
		page,
		router.basename
	]);
	if (!matches) return null;
	if (rsc) return /* @__PURE__ */ React8.createElement(RSCPrefetchPageLinksImpl, {
		page,
		matches,
		...linkProps
	});
...
function RSCPrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
	...
	return /* @__PURE__ */ React8.createElement(React8.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ React8.createElement("link", {
		key: href,
		rel: "prefetch",
		as: "fetch",
		href,
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
	...
	let newMatchesForData = React8.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "data"), [
		page,
		nextMatches,
		matches,
		manifest,
	...
	let newMatchesForAssets = React8.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "assets"), [
		page,
		nextMatches,
		matches,
		manifest,
	...
	return /* @__PURE__ */ React8.createElement(React8.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ React8.createElement("link", {
		...
		href,
		...linkProps
	})), moduleHrefs.map((href) => /* @__PURE__ */ React8.createElement("link", {
		key: href,
		rel: "modulepreload",
		href,
		...linkProps
	})), keyedPrefetchLinks.map(({ key, link }) => /* @__PURE__ */ React8.createElement("link", {
		key,
...
function Meta() {
	...
	return /* @__PURE__ */ React8.createElement(React8.Fragment, null, meta.flat().map((metaProps) => {
		...
		if ("tagName" in metaProps) {
			...
			let Comp = tagName;
			return /* @__PURE__ */ React8.createElement(Comp, {
				key: JSON.stringify(rest),
				...rest
			});
		}
		if ("title" in metaProps) return /* @__PURE__ */ React8.createElement("title", { key: "title" }, String(metaProps.title));
		if ("charset" in metaProps) {
			metaProps.charSet ?? (metaProps.charSet = metaProps.charset);
			delete metaProps.charset;
		}
		if ("charSet" in metaProps && metaProps.charSet != null) return typeof metaProps.charSet === "string" ? /* @__PURE__ */ React8.createElement("meta", {
			key: "charSet",
...
var RemixErrorBoundary = class extends React9.Component {
	...
	render() {
		if (this.state.error) return /* @__PURE__ */ React9.createElement(RemixRootDefaultErrorBoundary, {
...
function RemixRootDefaultErrorBoundary({ error, isOutsideRemixApp }) {
	console.error(error);
	let heyDeveloper = /* @__PURE__ */ React9.createElement("script", { dangerouslySetInnerHTML: { __html: `
        console.log(
          "\u{1F4BF} Hey developer \u{1F44B}. You can provide a way better UX than this when your app throws errors. Check out https://reactrouter.com/how-to/error-boundary for more information."
        );
      ` } });
	if (isRouteErrorResponse(error)) return /* @__PURE__ */ React9.createElement(BoundaryShell, { title: "Unhandled Thrown Response!" }, /* @__PURE__ */ React9.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), heyDeveloper);
	let errorInstance;
	...
	return /* @__PURE__ */ React9.createElement(BoundaryShell, {
		...
		isOutsideRemixApp
	}, /* @__PURE__ */ React9.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), /* @__PURE__ */ React9.createElement("pre", { style: {
		padding: "2rem",
...
function BoundaryShell({ title, renderScripts, isOutsideRemixApp, children }) {
	...
	}), /* @__PURE__ */ React9.createElement("title", null, title)), /* @__PURE__ */ React9.createElement("body", null, /* @__PURE__ */ React9.createElement("main", { style: {
		fontFamily: "system-ui, sans-serif",
		padding: "2rem"
	} }, children, renderScripts ? /* @__PURE__ */ React9.createElement(Scripts, null) : null)));
}
var React10 = await importShared("react");
...
function BrowserRouter({ basename, children, unstable_useTransitions, window: window2 }) {
	...
	let setState = React10.useCallback((newState) => {
		if (unstable_useTransitions === false) setStateImpl(newState);
		else React10.startTransition(() => setStateImpl(newState));
	}, [unstable_useTransitions]);
...
var Link = React10.forwardRef(function LinkWithRef({ onClick, discover = "render", prefetch = "none", relative, reloadDocument, replace: replace2, unstable_mask, state, target, to, preventScrollReset, viewTransition, unstable_defaultShouldRevalidate, ...rest }, forwardedRef) {
...
var Form = React10.forwardRef(({ discover = "render", fetcherKey, navigate, reloadDocument, replace: replace2, state, method = defaultMethod, action, onSubmit, relative, preventScrollReset, viewTransition, unstable_defaultShouldRevalidate, ...props }, forwardedRef) => {
	...
	let submitHandler = (event) => {
		...
		if (unstable_useTransitions && navigate !== false) React10.startTransition(() => doSubmit());
		else doSubmit();
	};
...
function useLinkClickHandler(to, { target, replace: replaceProp, unstable_mask, state, preventScrollReset, relative, viewTransition, unstable_defaultShouldRevalidate, unstable_useTransitions } = {}) {
	...
	return React10.useCallback((event) => {
		if (shouldProcessLinkClick(event, target)) {
			...
			if (unstable_useTransitions) React10.startTransition(() => doNavigate());
			else doNavigate();
		}
	}, [
		location,
...
function useSearchParams(defaultInit) {
	...
	let navigate = useNavigate();
	return [searchParams, React10.useCallback((nextInit, navigateOptions) => {
...
var React11 = await importShared("react");
...
function StaticRouterProvider({ context, router, hydrate: hydrate2 = true, nonce }) {
	...
	return /* @__PURE__ */ React11.createElement(React11.Fragment, null, /* @__PURE__ */ React11.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React11.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React11.createElement(FetchersContext.Provider, { value: fetchersContext }, /* @__PURE__ */ React11.createElement(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, /* @__PURE__ */ React11.createElement(Router, {
		...
		unstable_useTransitions: false
	}, /* @__PURE__ */ React11.createElement(DataRoutes, {
		routes: router.routes,
		future: router.future,
		state,
		isStatic: true
...
var React2$1 = await importShared("react");
...
var React4 = await importShared("react");
...
var React3$1 = await importShared("react");
var RSCRouterGlobalErrorBoundary = class extends React3$1.Component {
	constructor(props) {
		super(props);
		this.state = {
			error: null,
	...
	render() {
		if (this.state.error) return /* @__PURE__ */ React3$1.createElement(RSCDefaultRootErrorBoundaryImpl, {
			error: this.state.error,
			renderAppShell: true
		});
		else return this.props.children;
...
function ErrorWrapper({ renderAppShell, title, children }) {
	...
	return /* @__PURE__ */ React3$1.createElement("html", { lang: "en" }, /* @__PURE__ */ React3$1.createElement("head", null, /* @__PURE__ */ React3$1.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ React3$1.createElement("meta", {
		name: "viewport",
		content: "width=device-width,initial-scale=1,viewport-fit=cover"
	}), /* @__PURE__ */ React3$1.createElement("title", null, title)), /* @__PURE__ */ React3$1.createElement("body", null, /* @__PURE__ */ React3$1.createElement("main", { style: {
		fontFamily: "system-ui, sans-serif",
		padding: "2rem"
	} }, children)));
}
function RSCDefaultRootErrorBoundaryImpl({ error, renderAppShell }) {
	console.error(error);
	let heyDeveloper = /* @__PURE__ */ React3$1.createElement("script", { dangerouslySetInnerHTML: { __html: `
        console.log(
          "\u{1F4BF} Hey developer \u{1F44B}. You can provide a way better UX than this when your app throws errors. Check out https://reactrouter.com/how-to/error-boundary for more information."
        );
      ` } });
	if (isRouteErrorResponse(error)) return /* @__PURE__ */ React3$1.createElement(ErrorWrapper, {
		renderAppShell,
		title: "Unhandled Thrown Response!"
	}, /* @__PURE__ */ React3$1.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), heyDeveloper);
	let errorInstance;
	if (error instanceof Error) errorInstance = error;
	else {
		let errorString = error == null ? "Unknown Error" : typeof error === "object" && "toString" in error ? error.toString() : JSON.stringify(error);
	...
	return /* @__PURE__ */ React3$1.createElement(ErrorWrapper, {
		renderAppShell,
		title: "Application Error!"
	}, /* @__PURE__ */ React3$1.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), /* @__PURE__ */ React3$1.createElement("pre", { style: {
		padding: "2rem",
		background: "hsla(10, 50%, 50%, 0.1)",
		color: "red",
		overflow: "auto"
...
function RSCDefaultRootErrorBoundary({ hasRootLayout }) {
	...
	return /* @__PURE__ */ React3$1.createElement(RSCDefaultRootErrorBoundaryImpl, {
...
function RSCStaticRouter({ getPayload }) {
	...
	return /* @__PURE__ */ React4.createElement(RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React4.createElement(RSCRouterGlobalErrorBoundary, { location: payload.location }, /* @__PURE__ */ React4.createElement(FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React4.createElement(StaticRouterProvider, {
		context,
		router,
		hydrate: false,
		nonce: payload.nonce
...
var ReactDOM = await importShared("react-dom");
...
var React2 = await importShared("react");
var ssrInfo = null;
var router = null;
...
function HydratedRouter(props) {
	...
	return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FrameworkContext.Provider, { value: {
